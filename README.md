...
Multi-agent orchestration and autonomous execution.  Tools for agents.
...
Tools for humans and agents working together.

| Project | Description |
|---------|-------------|
| [wrkq](https://github.com/lherron/wrkq) | Task management CLI built for agent/human collaboration (Go) |
| [workboard](https://github.com/lherron/workboard) | Web UI for wrkq |
